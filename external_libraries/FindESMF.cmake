...
if(EXISTS ${ESMFMKFILE})
  ...
  # Add ESMF link libraries and options separately. Keeping options out of
  # INTERFACE_LINK_LIBRARIES lets CMake de-duplicate shared link flags.
  string(STRIP "${ESMF_F90LINKRPATHS} ${ESMF_F90ESMFLINKRPATHS} ${ESMF_F90ESMFLINKPATHS} ${ESMF_F90LINKPATHS} ${ESMF_F90LINKLIBS}" ESMF_INTERFACE_LINK_LIBRARIES)
  separate_arguments(ESMF_INTERFACE_LINK_OPTIONS UNIX_COMMAND "${ESMF_F90LINKOPTS}")
  string(STRIP "${ESMF_CLINKRPATHS} ${ESMF_CESMFLINKRPATHS} ${ESMF_CESMFLINKPATHS} ${ESMF_CLINKPATHS} ${ESMF_CLINKLIBS}" ESMC_INTERFACE_LINK_LIBRARIES)

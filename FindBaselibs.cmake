...
if (NOT BASEDIR)
   if (DEFINED ENV{BASELIBS})
     set (BASEDIR $ENV{BASELIBS})
   else()
     message (STATUS "WARNING: BASEDIR not specified. Set BASELIBS environment variable or use cmake ... -DBASEDIR=<path>.")
   endif()
endif()
